...
{"ip":"173.179.228.203"}
*/
const request = require("request"); // requiring the "request" (ie: library)
...
const fetchMyIP = function (callback) {
  ...
  request(url, (error, response, body) => {
    ...
    if (response.statusCode !== 200) {
      ...
      // body arg | info sent back (all data) from API
      // response arg | everything that the server said (including status codes) and reaction to that request
      return;
    }
